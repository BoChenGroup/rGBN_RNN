...
#input/output
dataname = "apnews" #  bnc apnews bnc

train_corpus="D:/PGBN_LSTM/Data/" + dataname + "/train.txt"
valid_corpus="D:/PGBN_LSTM/Data/" + dataname + "/valid.txt"
test_corpus="D:/PGBN_LSTM/Data/" + dataname + "/test.txt"
output_dir="output-DPGDS1_LSTM1"

output_prefix=dataname+"-1-model"
output_path = dataname+"-1-res"