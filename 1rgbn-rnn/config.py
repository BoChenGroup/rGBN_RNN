...
#training options
seed=1
rnn_layer_size=3 #n_layer
rnn_hidden_size1=600 #n_hidden
rnn_hidden_size2=600 #n_hidden
rnn_hidden_size3=600 #n_hidden
...
output_prefix=dataname+"-3-model-stack"
output_path = dataname+"-3-res-stack"
