...
#######################################LSTM_PARAM###############################################
        ...
        for j in range(config.sent_J):
            ...
            for t in range(config.lm_sent_len):
                ...
                self.h_t_1_theta = self.GRU_theta_hidden(self.theta_3c_norm, self.H_t_1, self.Uz3, self.Ur3, self.Uh3, self.Wz1, self.Wr1, self.Wh1, self.bz3, self.br3, self.bh3)
                ...
                self.h_t_3_theta = self.GRU_theta_hidden(self.theta_1c_norm, self.H_t_3, self.Uz1, self.Ur1, self.Uh1, self.Wz3, self.Wr3, self.Wh3, self.bz1, self.br1, self.bh1 )
